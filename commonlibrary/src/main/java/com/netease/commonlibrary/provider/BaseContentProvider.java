package com.netease.commonlibrary.provider;
...
public abstract class BaseContentProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues initialValues) {
        ...
        // L.i(null, "insert "+uri+","+initialValues.toString());
        ...
        if (!db.inTransaction()) {
            L.i(null, "insert1 " + uri + "," + initialValues.toString());
            sendNotify(uri);
        }
    ...
    public static Builder getBuilder(String[] keys, Object[] values, Builder builder) {
