...
public class ScreenSwitchUtils {
    ...
    private OrientationSensor callback;
...
//    public static ScreenSwitchUtils getInstance(Context context,OrientationSensor callback) {
//        if (mInstance == null) {
//            synchronized (ScreenSwitchUtils.class) {
//                if (mInstance == null) {
//                    mInstance = new ScreenSwitchUtils(context,callback);
//                }
//            }
//        }
//        return mInstance;
//    }
    ...
    public ScreenSwitchUtils(Context context,OrientationSensor callback) {
